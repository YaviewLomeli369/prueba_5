...
export default function WhatsAppWidget() {
  ...
  const shouldHide = location.startsWith('/admin') || 
                    ...
                    location.startsWith('/create-admin') ||
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 w-15 h-15 bg-green-500 text-white rounded-full flex items-center justify-center text-3xl shadow-lg z-[9999] hover:bg-green-600 transition-colors duration-200 no-underline"
      style={{
